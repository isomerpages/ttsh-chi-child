...
<div>
	<input type="checkbox" id="title3"><label for="title3">	<b>Implementing the Next Generation Electronic Medical Record for  
...
<br><img src="/images/proms%20n%20prems.jpg"><br>
	<input type="checkbox" id="title4"><label for="title4"><b>Improving Patient Care with the Electronic Patient Reported Outcome Measures (PROMs) and&nbsp;Patient Reported&nbsp;Experience Measures (PREMs) Programme</b><br>by <b>Centre for Healthcare Innovation</b></label>
	<div class="accordion-content">
